...
import { MedicineProfileSchema } from "../validations";

const MedicineProfileForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await MedicineProfileSchema.validate(profileData, { abortEarly: false });
      await axiosInstance.put("medicine/", profileData); // Use correct endpoint and send profileData
        ...
        <div className="mt-8 grid lg:grid-cols-2 gap-4">
          ...
          <div>
            ...
            >
              ...
              <option value="GM">Gastroenterology</option>
              <option value="CM">Cardiology</option>
              <option value="PM">Psychiatry</option>
            </select>
          ...
          {/* Repeat similar input fields for other profile data */}
        </div>
...
export default MedicineProfileForm;
